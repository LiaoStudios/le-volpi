      ...
      <div className="relative z-10 max-w-4xl px-6 text-center">
        ...
        >
          ...
          <a
            ...
            className="btn-organic inline-flex items-center gap-2 bg-[#F2B233] px-10 py-4 text-sm font-bold uppercase tracking-wider text-ink shadow-cta hover:bg-[#E0A21F]"
          >
